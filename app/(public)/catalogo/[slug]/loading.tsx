  ...
  return (
    <>
      ...
      <section className="flex flex-col items-center justify-center pt-28 pb-20 px-6 text-center">
        <Skeleton className="h-3 w-48 mx-auto rounded-none mb-8" />
        <Skeleton className="h-3 w-28 mx-auto rounded-none mb-5" />
        <Skeleton className="h-14 w-64 mx-auto rounded-none mb-6" />
